...
public class Posts2_2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_posts2_2);
    ...
    public void init() {
        ...
        Cursor cursor = database.rawQuery("select * from training where type = ? and gender = ?", new String[]{"dry", "man"});
        Cursor st = database.rawQuery("select COUNT(*) from training where type = ? and gender = ?", new String[]{"dry", "man"});
