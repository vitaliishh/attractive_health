...
public class WoPosts2_1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wo_posts2_1);
    ...
    public void init() {
        ...
        Cursor cursor = database.rawQuery("select * from training where type = ? and gender = ?", new String[]{"muscle", "woman"});
        Cursor st = database.rawQuery("select COUNT(*) from training where type = ? and gender = ?", new String[]{"muscle", "woman"});
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.backBtn:
                ...
                Intent intent = new Intent(this, WoWithCases2_1.class);
