...
public class WoPosts2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wo_posts2);
    ...
    public void init() {
        ...
        Cursor cursor = database.rawQuery("select * from training where type = ? and gender = ?", new String[]{"standart", "woman"});
        Cursor st = database.rawQuery("select COUNT(*) from training where type = ? and gender = ?", new String[]{"standart", "woman"});
