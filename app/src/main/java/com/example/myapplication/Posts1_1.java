...
public class Posts1_1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_posts1_1);
    ...
    public void init() {
        ...
        Cursor cursor = database.rawQuery("select * from diet where type = ? and gender = ?", new String[]{"muscle", "man"});
        Cursor st = database.rawQuery("select COUNT(*) from diet where type = ? and gender = ?", new String[]{"muscle", "man"});
