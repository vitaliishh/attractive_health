...
public class WoPosts1_2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wo_posts1_2);
    ...
    public void init() {
        ...
        Cursor cursor = database.rawQuery("select * from diet where type = ? and gender = ?", new String[]{"dry", "woman"});
        Cursor st = database.rawQuery("select COUNT(*) from diet where type = ? and gender = ?", new String[]{"dry", "woman"});
